...
export const APP_IDENTITY = {
  name: 'conting',
  uri: 'https://lab.ssafy.com/s10-blockchain-contract-sub2/S10P22C209',
  icon: 'favicon.ico',
};
...
const AuthorizationContext = React.createContext<AuthorizationProviderContext>({
  ...
  authorizeSession: (_wallet: AuthorizeAPI & ReauthorizeAPI) => {
    throw new Error('AuthorizationProvider가 초기화되지 않았습니다');
  },
...
function AuthorizationProvider(props: {children: ReactNode}) {
  ...
  const handleAuthorizationResult = useCallback(
    async (
      ...
      console.log('setAuthorization=', nextAuthorization);
