...
import { BUTTONSELECT, MAINBLACK, MAINWHITE, MAINYELLOW } from "../../../config/Color";
import { F_SIZE_BIGTEXT, F_SIZE_B_BUTTON, F_SIZE_TITLE } from "../../../config/Font";
import { ClipboardText, Edit, Gallery, VideoHorizontal, VideoPlay } from "iconsax-react-native";
        ...
        <KeyboardAwareScrollView style={styles.container}>
            <View style={styles.context}>
                ...
                <View style={styles.infos}>
                    <SimpleInput textColor={MAINBLACK} placeholder="제목 입력" backGroundColor={MAINWHITE} height={heightPercent(40)}/>
                </View>
                <View style={styles.title}>
                ...
                <View style={styles.infos}>
                    <MultiLineInput textColor={MAINBLACK} placeholder="소개 입력" width={widthPercent(355)} height={heightPercent(72)}/>
                    <View style={styles.space}/>
                    <View style={styles.row}>
                    <SimpleInput textColor={MAINBLACK} placeholder="파일 첨부" backGroundColor={MAINWHITE} width={widthPercent(250)} height={heightPercent(40)}/>
                ...
                <View style={styles.infos}>
                    <SimpleInput textColor={MAINBLACK} placeholder="URL" backGroundColor={MAINWHITE} height={heightPercent(40)}/>
                </View>
                <View style={styles.title}>
                ...
                <View style={styles.genre}>
                    ...
                    >
                    <Text style={[F_SIZE_B_BUTTON, selected==='발라드' && styles.selectedText]}>발라드</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                    ...
                    >
                    <Text style={[F_SIZE_B_BUTTON, selected==='랩/힙합' && styles.selectedText]}>랩/힙합</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                    ...
                    >
                    <Text style={[F_SIZE_B_BUTTON, selected==='락/메탈' && styles.selectedText]}>락/메탈</Text>
                    </TouchableOpacity>
                    <TouchableOpacity
                    ...
                    >
                    <Text style={[F_SIZE_B_BUTTON, selected==='재즈' && styles.selectedText]}>재즈</Text>
                    </TouchableOpacity>
                </View>
